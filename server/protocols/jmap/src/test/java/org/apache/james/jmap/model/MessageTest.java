...
public class MessageTest {
    ...
    public void buildShouldThrowWhenBlobIdIsNull() {
        Message.builder().id(InMemoryMessageId.of(1)).build();
    }

    @Test(expected=IllegalStateException.class)
    public void buildShouldThrowWhenThreadIdIsNull() {
        Message.builder().id(InMemoryMessageId.of(1)).blobId(BlobId.of("blobId")).build();
    }

    @Test(expected=IllegalStateException.class)
    public void buildShouldThrowWhenThreadIdIsEmpty() {
        Message.builder().id(InMemoryMessageId.of(1)).blobId(BlobId.of("blobId")).threadId("").build();
    }

    @Test(expected=IllegalStateException.class)
    public void buildShouldThrowWhenMailboxIdsIsNull() {
        Message.builder().id(InMemoryMessageId.of(1)).blobId(BlobId.of("blobId")).threadId("threadId").build();
    }

    @Test(expected=IllegalStateException.class)
    public void buildShouldThrowWhenHeadersIsNull() {
        Message.builder().id(InMemoryMessageId.of(1)).blobId(BlobId.of("blobId")).threadId("threadId").mailboxIds(ImmutableList.of()).build();
    }

    @Test(expected=IllegalStateException.class)
    public void buildShouldThrowWhenSubjectIsNull() {
        Message.builder().id(InMemoryMessageId.of(1)).blobId(BlobId.of("blobId")).threadId("threadId").mailboxIds(ImmutableList.of()).headers(ImmutableMap.of()).build();
    }

    @Test(expected=IllegalStateException.class)
    public void buildShouldThrowWhenSubjectIsEmpty() {
        Message.builder().id(InMemoryMessageId.of(1)).blobId(BlobId.of("blobId")).threadId("threadId").mailboxIds(ImmutableList.of()).headers(ImmutableMap.of())
            .subject("").build();
    }
    ...
    public void buildShouldWorkWhenMandatoryFieldsArePresent() {
        ...
        Message expected = new Message(InMemoryMessageId.of(1), BlobId.of("blobId"), "threadId", ImmutableList.of(InMemoryId.of(456)), Optional.empty(), false, false, false, false, false, ImmutableMap.of("key", "value"), Optional.empty(),
