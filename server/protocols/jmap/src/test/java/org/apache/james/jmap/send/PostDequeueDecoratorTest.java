...
public class PostDequeueDecoratorTest {
    ...
    public void doneShouldThrowWhenNameIsNotAValidMessageId() throws Exception {
        mail.setName("invalidId");

        testee.done(true);
    }

    @Test(expected=MessageIdNotFoundException.class)
    public void doneShouldThrowWhenNameIsNotAnExistingMessageId() throws Exception {
    ...
    public void doneShouldThrowWhenMessageIsNotInOutbox() throws Exception {
        ...
        mail.setName(USERNAME + "|" + SENT_MAILBOX_PATH.getName() + "|" + UID);
