...
public class MailDispatcherTest {
    ...
    public void dispatchShouldCustomizeDeliveredToHeader() throws Exception {
        AccumulatorDeliveredToHeaderMailStore accumulatorDeliveredToHeaderMailStore = new AccumulatorDeliveredToHeaderMailStore(MailDispatcher.DELIVERED_TO);
        MailDispatcher testee = MailDispatcher.builder()
            .log(mock(Log.class))
            .mailetContext(fakeMailContext)
    ...
    public void dispatchShouldNotAddSpecificHeaderIfRecipientDoesNotMatch() throws Exception {
        AccumulatorDeliveredToHeaderMailStore accumulatorTestHeaderMailStore = new AccumulatorDeliveredToHeaderMailStore(TEST_HEADER_NAME);
        MailDispatcher testee = MailDispatcher.builder()
            .log(mock(Log.class))
            .mailetContext(fakeMailContext)
    ...
    public static class AccumulatorDeliveredToHeaderMailStore implements MailStore {
        ...
        public AccumulatorDeliveredToHeaderMailStore(String headerName) {
