...
public abstract class AbstractJMSMailQueueTest {
    ...
    protected JMSMailQueue createQueue(ConnectionFactory factory, MailQueueActionProvider mailQueueActionProvider, String queueName) {
        Logger log = LoggerFactory.getLogger(AbstractJMSMailQueueTest.class);
        return new JMSMailQueue(factory, mailQueueActionProvider, queueName, log);
    }

    @Before
    public void setUp() throws Exception {
        ConnectionFactory connectionFactory = createConnectionFactory();
        setQueue(createQueue(connectionFactory, MailQueueActionProvider.NOOPProvider, QUEUE_NAME));
    }
