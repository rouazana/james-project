...
public class ActiveMQMailQueue extends JMSMailQueue implements ActiveMQSupport {
     ...
     * 
     */
    public ActiveMQMailQueue(final ConnectionFactory connectionFactory, final MailQueueActionFactory mailQueueActionFactory, final String queuename, final Logger logger) {
        this(connectionFactory, mailQueueActionFactory, queuename, true, logger);
    }
     ...
     * @param logger
     */
    public ActiveMQMailQueue(final ConnectionFactory connectionFactory, final MailQueueActionFactory mailQueueActionFactory, final String queuename, boolean useBlob, final Logger logger) {
        super(connectionFactory, mailQueueActionFactory, queuename, logger);
    ...
    protected MailQueueItem createMailQueueItem(Connection connection, Session session, MessageConsumer consumer, Message message) throws JMSException, MessagingException {
        ...
        return new ComposedMailQueueItem(activeMQMailQueueItem, mailQueueActionFactory.newAction());
    }
