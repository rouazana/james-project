...
public final class ExternalSession implements Session {
    ...
    public ExternalSession(final SocketChannel socket, Monitor monitor, String shabang) {
        this(socket, monitor, shabang, false);
    }

    public ExternalSession(final SocketChannel socket, Monitor monitor, String shabang, boolean debug) {
        super();
        this.socket = socket;
