...
public class ScriptedUserAdder implements UserAdder {
     ...
     */
    public ScriptedUserAdder(final String host, int port)
    {
        this(host, port, (String) null);
    }
    
    public ScriptedUserAdder(final String host, int port, String script) {
     ...
     */
    public ScriptedUserAdder(final String host, int port, Monitor monitor) {
        this(host, port, null, monitor);
    }
    
    public ScriptedUserAdder(final String host, int port, String script, Monitor monitor) {
        this.host = host;
        this.port = port;
        this.script = script;
     ...
     */
    public void addUser(final String user, String password) throws Exception {
     ...
     * @throws Exception upon failure
     */
    public void addUser(final String user, String password, Reader reader) throws Exception {
