...
public class FetchResponseEncoder extends AbstractChainedImapEncoder {
     ...
     */
    public FetchResponseEncoder(final ImapEncoder next, boolean neverAddBodyStructureExtensions) {
        super(next);
    ...
    private void encodeStructure(final ImapResponseComposer composer, Structure structure, boolean includeExtensions, boolean isInnerPart, ImapSession session) throws IOException {
    ...
    private void encodeStructure(final ImapResponseComposer composer, Structure structure, boolean includeExtensions, String mediaType, String subType, boolean isInnerPart, ImapSession session) throws IOException {
        //
    ...
    private void encodeBasic(final ImapResponseComposer composer, Structure structure, boolean includeExtensions, String mediaType, String subType, ImapSession session) throws IOException {
    ...
    private void encodeOnePartBodyExtensions(final ImapResponseComposer composer, Structure structure, ImapSession session) throws IOException {
    ...
    private ImapResponseComposer bodyFldDsp(final Structure structure, ImapResponseComposer composer, ImapSession session) throws IOException {
    ...
    private void bodyFldParam(final Map<String, String> params, ImapResponseComposer composer, ImapSession session) throws IOException {
    ...
    private void encodeBodyFields(final ImapResponseComposer composer, Structure structure, String mediaType, String subType) throws IOException {
    ...
    private void encodeBodyElements(final ImapResponseComposer composer, List<FetchResponse.BodyElement> elements) throws IOException {
        if (elements != null) {
    ...
    private void encodeEnvelope(final ImapResponseComposer composer, FetchResponse fetchResponse) throws IOException {
        final FetchResponse.Envelope envelope = fetchResponse.getEnvelope();
        encodeEnvelope(composer, envelope, true);
    }

    private void encodeEnvelope(final ImapResponseComposer composer, FetchResponse.Envelope envelope, boolean prefixWithName) throws IOException {
        if (envelope != null) {
    ...
    private void encodeAddresses(final ImapResponseComposer composer, FetchResponse.Envelope.Address[] addresses) throws IOException {
    ...
    private void encodeAddress(final ImapResponseComposer composer, FetchResponse.Envelope.Address address) throws IOException {
