...
public class StatusProcessor extends AbstractMailboxProcessor<StatusRequest> {
    ...
    public StatusProcessor(final ImapProcessor next, MailboxManager mailboxManager, StatusResponseFactory factory) {
    ...
    private Long unseen(final StatusDataItems statusDataItems, MessageManager.MetaData metaData) throws MailboxException {
        final Long unseen;
        if (statusDataItems.isUnseen()) {
    ...
    private Long uidValidity(final StatusDataItems statusDataItems, MessageManager.MetaData metaData) throws MailboxException {
    ...
    private Long highestModSeq(final StatusDataItems statusDataItems, MessageManager.MetaData metaData) throws MailboxException {
    ...
    private Long uidNext(final StatusDataItems statusDataItems, MessageManager.MetaData metaData) throws MailboxException {
        final Long uidNext;
    ...
    private Long recent(final StatusDataItems statusDataItems, MessageManager.MetaData metaData) throws MailboxException {
        final Long recent;
    ...
    private Long messages(final StatusDataItems statusDataItems, MessageManager.MetaData metaData) throws MailboxException {
        final Long messages;
