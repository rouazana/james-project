...
public class SearchProcessor extends AbstractMailboxProcessor<SearchRequest> implements CapabilityImplementingProcessor {
    ...
    public SearchProcessor(final ImapProcessor next, MailboxManager mailboxManager, StatusResponseFactory factory) {
     ...
     */
    private Long findHighestModSeq(final MailboxSession session, MessageManager mailbox, List<MessageRange> ranges, long currentHighest) throws MailboxException {
    ...
    private SearchQuery toQuery(final SearchKey key, ImapSession session) throws MessageRangeException {
    ...
    private SearchQuery.Criterion toCriterion(final SearchKey key, ImapSession session) throws MessageRangeException {
