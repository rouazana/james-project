...
public class EnableProcessor extends AbstractMailboxProcessor<EnableRequest> implements CapabilityImplementingProcessor {
    ...
    public EnableProcessor(final ImapProcessor next, MailboxManager mailboxManager, StatusResponseFactory factory, List<PermitEnableCapabilityProcessor> capabilities) {
        this(next, mailboxManager, factory);
        EnableProcessor.capabilities.addAll(capabilities);

    }

    public EnableProcessor(final ImapProcessor next, MailboxManager mailboxManager, StatusResponseFactory factory) {
