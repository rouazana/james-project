...
public class XListResponse extends AbstractListingResponse implements ImapResponseMessage {
    ...
    public XListResponse(final boolean noInferiors, boolean noSelect, boolean marked, boolean unmarked, boolean hasChildren, boolean hasNoChildren, String name, char delimiter, MailboxType type) {
