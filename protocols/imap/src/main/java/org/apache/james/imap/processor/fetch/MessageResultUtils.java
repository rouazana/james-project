...
public class MessageResultUtils {
     ...
     * @throws MessagingException
     */
    public static List<MessageResult.Header> getMatching(final String[] names, Iterator<MessageResult.Header> iterator) throws MailboxException {
     ...
     * @throws MessagingException
     */
    public static List<MessageResult.Header> getMatching(final Collection<String> names, Iterator<MessageResult.Header> iterator) throws MailboxException {
        return matching(names, iterator, false);
    }

    private static List<MessageResult.Header> matching(final Collection<String> names, Iterator<MessageResult.Header> iterator, boolean not) throws MailboxException {
     ...
     * @throws MessagingException
     */
    public static List<MessageResult.Header> getNotMatching(final Collection<String> names, Iterator<MessageResult.Header> iterator) throws MailboxException {
     ...
     * @throws MessagingException
     */
    public static MessageResult.Header getMatching(final String name, Iterator<MessageResult.Header> iterator) throws MailboxException {
     ...
     * @throws MessagingException
     */
    public static List<MessageResult.Header> getNotMatching(final String[] names, Iterator<MessageResult.Header> iterator) throws MailboxException {
        final List<MessageResult.Header> results = new ArrayList<MessageResult.Header>(20);
        if (iterator != null) {
            while (iterator.hasNext()) {
                MessageResult.Header header = iterator.next();
