...
public class DefaultImapDecoder implements ImapDecoder {
    ...
    public DefaultImapDecoder(final StatusResponseFactory responseFactory, ImapCommandParserFactory imapCommands) {
        this(responseFactory, imapCommands, DEFAULT_MAX_INVALID_COMMANDS);
    }

    public DefaultImapDecoder(final StatusResponseFactory responseFactory, ImapCommandParserFactory imapCommands, int maxInvalidCommands) {
    ...
    private ImapMessage decodeCommandTagged(final ImapRequestLineReader request, String tag, ImapSession session) {
        ImapMessage message;
    ...
    private ImapMessage unknownCommand(final String tag, ImapSession session) {
        ImapMessage message;
    ...
    private ImapMessage decodeCommandNamed(final ImapRequestLineReader request, String tag, String commandName, ImapSession session) {
        ImapMessage message;
        if (session.getLog().isDebugEnabled()) {
