...
public class ListingEncodingUtils {
    ...
    public static void encodeListingResponse(final String responseTypeName, ImapResponseComposer composer, AbstractListingResponse response) throws IOException {
