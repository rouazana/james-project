...
public class MaildirMessageMapper extends AbstractMessageMapper<MaildirId> {
     ...
     */
    @Override
    public Iterator<UpdatedFlags> updateFlags(final Mailbox<MaildirId> mailbox, FlagsUpdateCalculator flagsUpdateCalculator, MessageRange set) throws MailboxException {
