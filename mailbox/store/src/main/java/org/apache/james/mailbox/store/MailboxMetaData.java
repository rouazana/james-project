...
public class MailboxMetaData implements MessageManager.MetaData {
    ...
    public MailboxMetaData(final List<Long> recent, Flags premanentFlags, long uidValidity, long nextUid, long highestModSeq, long messageCount, long unseenCount, Long firstUnseen, boolean writeable, boolean modSeqPermanent, MailboxACL acl) {
        super();
        if (recent == null) {
