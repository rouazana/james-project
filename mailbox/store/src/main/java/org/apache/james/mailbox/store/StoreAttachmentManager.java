...
public class StoreAttachmentManager implements AttachmentManager {
    ...
    @Override
    public void storeAttachmentsForMessage(Collection<Attachment> attachments, MessageId messageId, MailboxSession mailboxSession) throws MailboxException {
        getAttachmentMapper(mailboxSession).storeAttachmentsForMessage(attachments, messageId);
    }
}
