...
public class JCRMailboxSessionMapperFactory extends MailboxSessionMapperFactory<JCRId> {
    ...
    public JCRMailboxSessionMapperFactory(final MailboxSessionJCRRepository repository, UidProvider<JCRId> uidProvider, ModSeqProvider<JCRId> modSeqProvider) {
        this(repository, uidProvider, modSeqProvider, DEFAULT_SCALING, JCRMessageMapper.MESSAGE_SCALE_DAY);
    }

    public JCRMailboxSessionMapperFactory(final MailboxSessionJCRRepository repository, UidProvider<JCRId> uidProvider, ModSeqProvider<JCRId> modSeqProvider, int scaling, int messageScaling) {
