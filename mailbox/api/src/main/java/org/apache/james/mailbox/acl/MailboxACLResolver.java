...
public interface MailboxACLResolver {
     ...
     * @throws UnsupportedRightException
     */
    MailboxACLRights[] listRights(final MailboxACLEntryKey key, GroupMembershipResolver groupMembershipResolver, String resourceOwner, boolean resourceOwnerIsGroup) throws UnsupportedRightException;
