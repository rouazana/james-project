...
public class MailboxQueryTest {
    ...
    public void getCombinedNameShouldReturnEmptyStringWhenNullMailboxPathAndExpression() throws Exception {
        //Given
        MailboxPath mailboxPath = new MailboxPath(null, null, null);
        MailboxQuery testee = new MailboxQuery(mailboxPath, null, '.');
        //When
        String actual = testee.getCombinedName();
        //Then
    ...
    @Test
    public void getCombinedNameShouldIgnoreDelimiterWhenPresentAtBeginingOfExpression() throws Exception {
        //Given
        MailboxPath mailboxPath = new MailboxPath("namespace", "user", "name");
        MailboxQuery testee = new MailboxQuery(mailboxPath, ".mailbox", '.');
        //When
    ...
    public void getCombinedNameShouldIgnoreDelimiterWhenPresentAtEndOfMailboxName() throws Exception {
        //Given
        MailboxPath mailboxPath = new MailboxPath(null, null, "name.");
        MailboxQuery testee = new MailboxQuery(mailboxPath,  "mailbox", '.');
        //When
        String actual = testee.getCombinedName();
        //Then
    ...
    @Test
    public void getCombinedNameShouldIgnoreDelimiterWhenPresentAtBeginingOfExpressionAndEndOfMailboxName() throws Exception {
        //Given
        MailboxPath mailboxPath = new MailboxPath(null, null, "name.");
        MailboxQuery testee = new MailboxQuery(mailboxPath, ".mailbox", '.');
        //When
    ...
    @Test
    public void isExpressionMatchShouldIgnoreSubFolderWhenLocalWildcardAtEnd() throws Exception {
        //Given
        MailboxPath mailboxPath = new MailboxPath("namespace", "user", "name");
        MailboxQuery testee = new MailboxQuery(mailboxPath, "mailbox%", '.');
        //When
    ...
    public void isExpressionMatchShouldMatchDeeplyNestedFoldeWhenMixedFreeLocalWildcards() throws Exception {
        ...
        MailboxQuery testee = new MailboxQuery(mailboxPath, "sub*mailbox%sub", '.');
        //When
        boolean actual = testee.isExpressionMatch("sub.mailbox.submailboxsub");
        //Then
        assertThat(actual).isTrue();
    }
    ...
    @Test
    public void isExpressionMatchShouldNotEscapedFreeWildcard() throws Exception {
        //Given
        MailboxPath mailboxPath = new MailboxPath("namespace", "user", "name");
    ...
    @Test
    public void isExpressionMatchShouldNotEscapedLocalWildcard() throws Exception {
        //Given
        MailboxPath mailboxPath = new MailboxPath("namespace", "user", "name");
        MailboxQuery testee = new MailboxQuery(mailboxPath, "folder\\%", '.');
        //When
