...
public class SizeChangesDao {
    ...
    @Inject
    public SizeChangesDao(Session session, CassandraUtils cassandraUtils) {
    ...
    private PreparedStatement prepareInsert(Session session) {
        return session.prepare(insertInto(CassandraQuotaThresholdHistoryStoreTable.SIZE_TABLE_NAME)
    ...
    private PreparedStatement prepareSelect(Session session) {
        return session.prepare(select()
            .from(CassandraQuotaThresholdHistoryStoreTable.SIZE_TABLE_NAME)
