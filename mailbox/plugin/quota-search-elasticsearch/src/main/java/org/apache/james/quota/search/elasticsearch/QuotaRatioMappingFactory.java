...
import static org.apache.james.quota.search.elasticsearch.json.JsonMessageConstants.QUOTA_COUNT_RATIO;
import static org.apache.james.quota.search.elasticsearch.json.JsonMessageConstants.QUOTA_SIZE_RATIO;
                ...
                .startObject()
                    ...
                    .startObject(QuotaRatioElasticSearchConstants.QUOTA_RATIO_TYPE.getValue())
                        .startObject(PROPERTIES)
                            ...
                            .startObject(QUOTA_COUNT_RATIO)
                                .field(TYPE, LONG)
                            .endObject()

                            .startObject(QUOTA_SIZE_RATIO)
                                .field(TYPE, LONG)
                            .endObject()
                        .endObject()
                    .endObject()
