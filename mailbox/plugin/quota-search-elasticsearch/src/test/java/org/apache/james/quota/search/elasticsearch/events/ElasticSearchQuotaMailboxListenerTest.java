...
import org.apache.james.quota.search.QuotaSearchFixture.Quotas.Counts;
import org.apache.james.quota.search.QuotaSearchFixture.Quotas.Sizes;
...
public class ElasticSearchQuotaMailboxListenerTest {
    ...
    public void eventShouldDoNothingWhenNoQuotaEvent() throws Exception {
        quotaMailboxListener.event(new Event() {
